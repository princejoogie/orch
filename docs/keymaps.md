...
- Add-session dialog scope handles cancel, input/selector focus switching, focused worktree and model selector navigation, provider-to-model selection commit, and focused non-primary worktree removal.
